...
namespace GodRust
{
   ...
   public static class Primitives2D
   {
      ...
      private static void CreateThePixel(this SpriteBatch spriteBatch)
      {
      ...
      private static void DrawPoints(this SpriteBatch spriteBatch, Vector2 position, List<Vector2> points, Color color, float thickness)
      {
         if (points.Count < 2)
            return;
